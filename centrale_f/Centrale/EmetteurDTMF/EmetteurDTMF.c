...
static const uint32_t DTMF_STEP_LOW[4] = {
    299359221,  // 697 Hz  (HEX: 0x11D7B1FD)
    330712482,  // 770 Hz  (HEX: 0x13B63DA2) <-- ?????? ?????? "5"
    365931214,  // 852 Hz  (HEX: 0x15D1C3DE)
    404156423   // 941 Hz  (HEX: 0x18196E87)
};

static const uint32_t DTMF_STEP_HIGH[4] = {
    519261546,  // 1209 Hz (HEX: 0x1EF440AA)
    573807631,  // 1336 Hz (HEX: 0x22339C0F) <-- ??????? ?????? "5"
    634366696,  // 1477 Hz (HEX: 0x25CF1B68)
    701368159   // 1633 Hz (HEX: 0x29CCA6DF)
};*/
